...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_BADGE_COLOR = 0xFF21282E;// Color.BLACK;//parseColor("#CCFF0000");
																// //Color.BLACK;
	...
	private void show(boolean animate, Animation anim) {
		if (getBackground() == null) {
			if (badgeBg == null) {
				...
				badgeBg = getResources().getDrawable(R.drawable.badge);
			}
			setBackgroundDrawable(badgeBg);
		}
		// setBackground(getResources().getDrawable( R.drawable.badge ));
		applyLayoutParams();
	...
	private Drawable getDefaultBackground() {
		...
		//
		// RoundRectShape rr = new RoundRectShape(outerR, null, outerR);
		// ShapeDrawable drawable = new ShapeDrawable(rr);
		// drawable.getPaint().setColor(badgeColor);

		// ShapeDrawable drawable = (ShapeDrawable)getResources().getDrawable(
		// R.drawable.badge );

		return getResources().getDrawable(R.drawable.badge);
